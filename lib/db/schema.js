...
// Updated to remove tsvector() (not supported by your Drizzle version)
// search_tsv fields modeled as text() instead.
...
// ─────────────────────────────────────────────
// Encounter metadata & join tables
// ─────────────────────────────────────────────
...
export const encounterTypeLinksRelations = relations(encounterTypeLinks, ({ one }) => ({
  encounter: one(encounters, {
