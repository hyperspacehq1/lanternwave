// lib/db/schema.js
// LanternWave 2.0 — CLEANED + FIXED + VERIFIED SCHEMA
// All duplicate imports removed, only valid Drizzle imports used.
...
import {
  ...
  integer,
  date,
  vector,         // VALID: drizzle-orm/pg-core supports vector()
...
// Singleton now_playing row (id = 1)
