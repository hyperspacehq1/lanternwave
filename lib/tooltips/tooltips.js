export const TOOLTIPS = {
  ...
  account: {
    ...
    audio_player: {
      ...
      body:
        "When enabled, audio will also play on the Player Page. Disable this if you prefer audio to play only from the GM Controller.",
    },
  },
  ...
  player: {
    help: {
      title: "Player View",
      body:
        "Designed to run on a separate screen for players. The GM controls what appears here from the Controller on their own device.",
    },
  },
};
