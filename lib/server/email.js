...
function baseTemplateModel({ username, userAgent }) {
  ...
  return {
    // identity
    name: username,
    username, // ✅ required by templates
...
export async function sendWelcomeEmail({
  ...
  return client.sendEmailWithTemplate({
    ...
    TemplateModel: baseTemplateModel({ username, userAgent }),
  });
}
...
export async function sendPasswordResetEmail({
  ...
  return client.sendEmailWithTemplate({
    From: process.env.POSTMARK_FROM_EMAIL,
    To: to,
    TemplateAlias: "password-reset", // ✅ matches screenshot
    TemplateModel: {
...
export async function sendForgotUsernameEmail({
  ...
  return client.sendEmailWithTemplate({
    From: process.env.POSTMARK_FROM_EMAIL,
    To: to,
    TemplateAlias: "forgot-username", // ✅ matches screenshot
    TemplateModel: baseTemplateModel({ username, userAgent }),
  });
}
